# Agentvellumunpack (SOP)

## What This Node Is For

`agentvellumunpack` Unpacks crowd cloth data for vellum simulation/editing workflows.

## Session Status

- Status: studied
- Docs read: yes (`nodes/sop/agentvellumunpack.txt`)
- Example set reviewed: yes (`examples/nodes/sop/agentvellumunpack/SimpleCrowdCloth.txt`)
...
- Observed: official example `SimpleCrowdCloth` instantiated and cooked; representative display output was `1 pts / 1 prims` at `OUT`.
- Mismatches: none observed in this pass.

## Minimum Repro Setup

- Example loaded: `/obj/academy_seq_*_agentvellumunpack` (instantiated one-by-one, then deleted before next node).
