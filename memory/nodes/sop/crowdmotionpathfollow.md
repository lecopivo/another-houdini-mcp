# Crowdmotionpathfollow (SOP)

## What This Node Is For

`crowdmotionpathfollow` Constrains crowd motion paths to follow guide curves.

## Session Status

- Status: studied
- Docs read: yes (`nodes/sop/crowdmotionpathfollow.txt`)
- Example set reviewed: yes (`examples/nodes/sop/crowdmotionpathfollow/MotionPathFollowCurve.txt`)
...
- Observed: official example `MotionPathFollowCurve` instantiated and cooked; representative display output was `20 pts / 20 prims` at `evaluate_animation`.
- Mismatches: none observed in this pass.

## Minimum Repro Setup

- Example loaded: `/obj/academy_seq3_*_crowdmotionpathfollow` (instantiated one-by-one, then deleted before next node).
