"""Legacy bridge tool wrappers extracted from houdini_mcp_server.py."""
...
def search_documentation_files(
    ...
    Args:
        ...
        search_mode: Match strategy: 'any' (default) or 'all'
        max_results: Maximum number of results (default: 30, max: 200)
        context_chars: Snippet context radius around content matches (default: 100)
...
def get_legacy_bridge_functions(send_command_impl):
    global send_command
    ...
    return {
        ...
        "get_parameter_info": get_parameter_info,
        "list_node_categories": list_node_categories,
        "list_node_types": list_node_types,
        "get_node_documentation": get_node_documentation,
        "list_python_commands": list_python_commands,
        "get_python_documentation": get_python_documentation,
        "execute_python": execute_python,
        "search_python_documentation": search_python_documentation,
        "get_node_connections": get_node_connections,
        "execute_hscript": execute_hscript,
        "search_documentation_files": search_documentation_files,
        "read_documentation_file": read_documentation_file,
        "create_digital_asset": create_digital_asset,
        "set_hda_lock_state": set_hda_lock_state,
        "save_hda_definition": save_hda_definition,
        "get_hda_definition_info": get_hda_definition_info,
        "edit_parameter_interface": edit_parameter_interface,
        "set_parameter_conditionals": set_parameter_conditionals,
        "bind_internal_parameters": bind_internal_parameters,
        "set_primitive_type_by_token": set_primitive_type_by_token,
        "set_output_node_index": set_output_node_index,
        "validate_hda": validate_hda,
        "get_hda_parm_templates": get_hda_parm_templates,
        "set_hda_parm_templates": set_hda_parm_templates,
        "set_hda_parm_default": set_hda_parm_default,
        "set_hda_internal_binding": set_hda_internal_binding,
        "set_hda_internal_parm": set_hda_internal_parm,
        "save_hda_from_instance": save_hda_from_instance,
        "instantiate_hda": instantiate_hda,
        "probe_geometry": probe_geometry,
        "validate_hda_behavior": validate_hda_behavior,
    }
